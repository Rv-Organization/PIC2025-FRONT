<template>
  <v-app>
    <v-container class="container-sug">
      ...
      <h4 class="pt-4">
        En este espacio debe llenar el formulario para realizar las sugerencias sobre el panel de votaciones de los Premios Indias Catalina.
      </h4>
      ...
      <v-container>
        <v-row justify="center">
          <v-col cols="12" xs="12" sm="12" md="12" lg="12" xl="12" class="text-center">
            <v-btn color="boton" height="50" class="botone white--text" :disabled="!validacion" @click="enviarSugerencia()" elevation="0"
              >Enviar</v-btn
            >
          </v-col>
        </v-row>
